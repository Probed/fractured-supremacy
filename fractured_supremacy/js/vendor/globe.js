...
var URLS = {
    bg: 'image/celestial_object/css_globe_bg.jpg',
    diffuse: 'image/celestial_object/earth.jpg',
    halo: 'image/celestial_object/css_globe_halo.png',
};
...
function render() {
	...
	config.lng = clampLng(config.lng - 0.005);
    }
