...
CREATE TABLE `resource` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `resource_type` bigint(20) unsigned NOT NULL,
  `universe_id` bigint(20) unsigned NOT NULL,
  `qty` int(10) unsigned NOT NULL DEFAULT '0',
  `options` text NULL,
  PRIMARY KEY (`id`),
  KEY `resource_resource_type_id` (`resource_type`),
  KEY `resource_universe_id` (`universe_id`),
  CONSTRAINT `resource_resource_type_id` FOREIGN KEY (`resource_type`) REFERENCES `resource_type` (`id`) ON UPDATE CASCADE,
